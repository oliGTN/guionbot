...
<div class="navbar">
    ...
    <a href="/pdatacrons.php?ac=<?php echo rawurlencode((string) $allycode); ?>" class="<?php echo substr($_SERVER['REQUEST_URI'], 0, strlen('/pdatacrons.php')) == '/pdatacrons.php' ? 'active' : ''; ?>">Datacrons</a>
