    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="hide-on-med-and-down <?php echo ($sort_column === 's_fights') ? 'active-sort' : ''; ?>"><a href="tw.php?id=<?php echo $_GET['id'];?>&sort=s_fights&order=<?php echo ($sort_column=='s_wins'?$next_order:'DESC'); ?>">Ship wins</a></th>
