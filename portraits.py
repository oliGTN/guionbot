...
def get_image_from_id(character_id):
    ...
    return Image.open(character_img_name)
...
def get_image_from_team(list_character_ids, db_data):
    ...
    for character_id in list_character_ids:
        character_data = [line for line in db_data if line[0] == character_id][0]
        rarity = character_data[1]
        level = character_data[2]
        gear = character_data[3]
        relic = character_data[4]-2
        force_alignment = character_data[5]
        zetas = character_data[6]
        combatType = character_data[7]
        ...
        if combatType == 1:
            ...
            print("ERR: no portrait for ship "+character_id)
